...
var JSControl = function() {
   if (!(this instanceof JSControl)) return new JSControl();
...
JSControl.prototype.fireActionListeners = function() {
   ...
   for (var i in this.actionListeners) {
      ...
      if (typeof(listener) === "function") {
         ...
         var bits = (this.triggerEvent == null) ?
                       0 : this.triggerEvent.getModifiers();
         if (!e) e = new ActionEvent(this, ActionEvent.ACTION_PERFORMED,
                                     this.getActionCommand(), bits);
...
JSControl.prototype.setUpdater = function(updater) {
   this.updater = updater;
};

JSControl.prototype.update = function() {
