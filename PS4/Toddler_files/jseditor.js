...
var JSEditor = function() {
   if (!(this instanceof JSEditor)) return new JSEditor();
   JSPanel.call(this);
...
JSEditor.prototype.setTabSize = function(columns) {
   var session = this.aceEditor.getSession();
   session.setTabSize(columns);
...
JSEditor.prototype.addBackgroundHighlight = function(a1, a2, a3) {
   var p1 = (a3 === undefined) ? this.getLineStart(a1) : a1;
   var p2 = (a3 === undefined) ? this.getLineStart(a1 + 1) : a2;
   var color = (a3 === undefined) ? a2 : a3;
   // Fill in highlighting
   return 0;
};

JSEditor.prototype.removeBackgroundHighlight = function(key) {
...
JSEditor.prototype.setPathname = function(pathname) {
   this.pathname = pathname;
};

JSEditor.prototype.getPathname = function() {
   return this.pathname;
};

JSEditor.prototype.setSaveNeeded = function(flag) {
   this.needsSaving = flag;
};

JSEditor.prototype.isSaveNeeded = function() {
   return this.needsSaving;
};

JSEditor.prototype.setScrollTarget = function(target) {
   this.scrollTarget = target;
};

JSEditor.prototype.getScrollTarget = function() {
...
JSEditor.prototype.showFindAndReplaceDialog = function() {
   // Not yet implemented
};

JSEditor.prototype.findNext = function(str) {
   return false; // Not yet implemented
};

JSEditor.prototype.replace = function(str, replacement) {
   return false; // Not yet implemented
};

JSEditor.prototype.replaceAll = function(str, replacement) {
   // Not yet implemented
};

JSEditor.prototype.setUndoableFlag = function(flag) {
//   this.undoable = flag;
};

JSEditor.prototype.getUndoableFlag = function() {
   return this.undoable;
};

JSEditor.prototype.getUndoAction = function() {
   return null;   // Not yet implemented
};

JSEditor.prototype.getRedoAction = function() {
   return null;   // Not yet implemented
};
...
var Marker = function(editor, anchor) {
   if (!(this instanceof Marker)) return new Marker(editor, anchor);
   this.editor = editor;
   this.anchor = anchor;
};
...
var OffsetRange = function(start, end) {
   if (!(this instanceof OffsetRange)) return new OffsetRange(start, end);
   this.start = start;
   this.end = end;
};
...
var EditorMode = function() {
   if (!(this instanceof EditorMode)) return new EditorMode();
   this.ruleTable = {};
   this.styleTable = {};
   this.modeName = null;
};
